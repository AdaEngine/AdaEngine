...
struct AdaEngineStyleUITests {
    ...
    func requiredReferenceLabels() {
        ...
        #expect(AdaEngineStyleContent.projectTreeItems == ["src", "EngineLoop.ada", "Renderer.ada"])
        #expect(AdaEngineStyleContent.editorTabs.contains("MainLevel.scene"))
    ...
    func editorViewModelDefaults() {
        ...
        #expect(viewModel.workbench.activeEditorTab == "MainLevel.scene")
    ...
    func editorViewModelMutatesInteractionState() {
        ...
        viewModel.toolStrip.hoveredTool = "AI"
        ...
        #expect(viewModel.toolStrip.hoveredTool == "AI")
