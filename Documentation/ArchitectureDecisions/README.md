...
| [ADR-0006](0006-ada-script-adaui-integration.md) | Accepted | Partial (foundation shipped) | Native AdaUI view graphs, state, bindings, snapshots, and event routing for AdaScript |
