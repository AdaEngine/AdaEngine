...
public protocol System: Sendable {
    ...
    /// - Note: This property is automatically generated by ``System(dependencies:)`` or ``PlainSystem(dependencies:)`` macro. Macro grab all properties with `Query` suffix and confirmed ``SystemParameter`` protocol, example: `@CustomQuery`.
