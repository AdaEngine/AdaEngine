...
public protocol System {
    ...
    /// - Note: This property is automatically generated by ``System(dependencies:)`` or ``PlainSystem(dependencies:)`` macro. Macro grab all properties with `Query` suffix and comfirmed ``SystemQuery`` protocol, example: `@CustomQuery`.
