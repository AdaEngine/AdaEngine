...
//    }
//    
//    func beginDrawContext(for window: WindowRef, viewTransform: Transform3D) throws -> DrawContext {
...
//    }
//    
//    func beginDrawContext(for camera: Camera, viewUniform: GlobalViewUniform) throws -> DrawContext {
//        let frameIndex = RenderEngine.shared.currentFrameIndex
//        let device = RenderEngine.shared.renderDevice
//
//        let uniform = Self.shared.uniformSet.getBuffer(binding: GlobalBufferIndex.viewUniform, set: 0, frameIndex: frameIndex)
...
//        let commandEncoder: RenderCommandEncoder
//        private var lineWidth: Float = 1
//        private let renderEngine: Renderer2D
//        private let frameIndex: Int
//        
//        init(commandEncoder: RenderCommandEncoder, renderEngine: Renderer2D, frameIndex: Int) {
...
//            self.commandEncoder.pushDebugName(name)
//        }
//        
//        public func setLineWidth(_ width: Float) {
//            self.commandEncoder.setLineWidth(width)
//        }
//        
